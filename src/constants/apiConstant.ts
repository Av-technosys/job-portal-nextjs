export const apiConstantsURL = {
  ...
  profile: {
    ...
    jobseekerFullDetails: `user_profiles/job_seeker_details/`,
    recruiterFullDetails: `user_profiles/recruiter_details/`,
    ApplicantDetails: `user_profiles/job_seeker_general/`,
    ApplicantSocialLinks: `user_profiles/social_urls_job_seeker/`,
    ApplicantPersonalDetails: `user_profiles/job_seeker_personal/`,
    ...
    companyProfileById: `user_profiles/company_profile/`,
    recruiterFounding: `user_profiles/recruiter_founding/`,
    recruiterFoundingById: `user_profiles/recruiter_founding/`,
  ...
  assessment: {
    ...
    getQuestionsBySubjectId: `assessment/get_test_question/`,
    getFreeQuestionsBySubjectId: `assessment/get_free_test_question/`,
    assessmentAnsweredData: `assessment/submit_test/`,
